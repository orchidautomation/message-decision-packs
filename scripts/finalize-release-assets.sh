...
for required in SHA256SUMS.txt install.sh install-agents.sh install-cli.sh install-codex.sh release-manifest.json; do
...
for required_checksum in install.sh install-agents.sh install-cli.sh install-codex.sh release-manifest.json; do
