...
assert.match(script, /SMOKE_SELECTOR='\^\(from_run\|permits_projection\)\$'/u)
assert.ok(script.includes("SMOKE_SELECTORS=('from_run' 'permits_projection')"), 'smoke selectors must be declared in order')
