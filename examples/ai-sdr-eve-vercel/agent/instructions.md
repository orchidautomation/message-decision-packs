...
1. Load `mdp-pack-apply` for pack-grounded fit and brief procedure, or `mdp` for CLI/operator guidance. Public-source discovery remains an Eve/provider responsibility outside MDP.
