# Governed proposal evidence and execution protocol

Load this reference only after selecting one proposal review mode.

## Managed bundle default

For a normal review, use the shared managed workflow bundle handoff.
