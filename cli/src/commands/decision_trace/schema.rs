        ...
        "properties": {
            ...
            "source": {
                ...
                "properties": {
                    ...
                    "command": {"type": "string"},
                    "sha256": {"type": "string", "pattern": "^$|^[0-9a-f]{64}$"},
                    "class": {"enum": ["unknown", "row-level", "prompt-output-validation", "run-execution", "receipt-backed-run", "composite-conformance"]}
                }
            },
            "authority": {
                "type": "object", "additionalProperties": false,
                ...
                "properties": {
                    ...
                    "decision_authority": {"enum": ["none", "source-artifact", "validation-receipt", "run-receipt-reference", "run-receipt", "composite-conformance"]},
