...
pub(crate) fn capabilities() -> Value {
    json!({
        ...
        "commands": [
            ...
            command("validate-prompt-output", "mdp.validate-prompt-output.v0", "read-only", false, false, true, &["--dir", "--file", "--source-audit", "--source-attempt-request", "--prompt", "--prompt-id", "--strict"]),
