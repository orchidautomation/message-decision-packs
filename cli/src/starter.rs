...
fn outbound_model_task_prompt(job_id: &str, id: &str, kind: &str) -> Value {
    ...
    json!({
        ...
        "instructions": [
            ...
            "Return strict JSON only with semantic fields; MDP adds and validates deterministic provenance fields after generation.",
        ...
        "provenance_policy": ["Retain the exact authority identifiers used to produce or review the artifact.", "Return semantic decisions only; MDP owns the final prompt, job, context, receipt, and input-inventory envelope."],
        ...
        "final_checklist": ["Output is strict JSON with only semantic fields.", "All selected identifiers are declared and unambiguous.", "Gaps and rejected claims are explicit.", "Generated copy is substantive before status is ready and remains ready for separate verify-output validation."],
        "output_contract": {
