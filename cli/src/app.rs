...
use crate::commands::{
    ...
    check_readme, compile_candidate_file, demo_copy, doctor, emit_brief_scoped, eval_pack,
    execute_upgrade, explain, gaps, init_pack_targeted, init_pack_targeted_dry_run, pack,
    preview_pack_change_set, project_conformance_report, project_decision_card_inputs,
    ...
    status, upgrade_check, validate_behavioral_files, validate_pack,
...
pub(crate) fn run(cli: Cli) -> Result<()> {
    ...
    match command {
        ...
        Commands::CheckClaims {
            ...
            let data = crate::commands::check_claims_artifact_scoped(
                &dir,
                text.as_deref(),
                file.as_deref(),
                subject.as_deref(),
