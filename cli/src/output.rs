...
fn summarize(command: &str, data: &Value) -> Value {
    match command {
        ...
        "route" => json!({
            ...
            "job": data["job"],
            "scope": data["scope"],
            "selector_contract": data["selector_contract"],
            "candidate_only": data["candidate_only"],
        ...
        "fit" => json!({
            ...
            "candidate_only": data["candidate_only"],
            "candidate_count": data["candidate_count"],
            "rejection_count": array_len(&data["rejections"]),
            "portfolio_sensitive": data["portfolio_sensitive"],
...
fn context_summary(context: &Value) -> Value {
    ...
    let mut summary = json!({
        ...
        "scope": context["scope"],
        "selector_contract": context["selector_contract"],
