...
.PHONY: validate validate-cli validate-template validate-skills validate-skill-sync validate-asset-sync validate-plugin validate-pluxx-hooks validate-installers validate-llms install-cli demo

validate: validate-cli validate-template validate-skills validate-skill-sync validate-asset-sync validate-plugin validate-pluxx-hooks validate-installers validate-llms
