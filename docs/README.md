...
- [Pluxx Distribution Evaluation](pluxx-distribution-evaluation.md): the evidence worksheet and keep/further-narrow/switch gate; no final verdict before public installed proof.
